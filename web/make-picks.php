...
<html>
  ...
  <div class="center" id="make-picks">
    ...
    <h2>Week 13 - November 29th - December 3nd</h2>
    <form action="submit-picks.php" method="post" onsubmit="return submitSheet();">
      ...
      <?php
      $result = pg_query($conn, "select * from weekly_matches where week_number = '$week_number' and match_date = '2018-11-29' order by id asc;");
      ...
      <?php
      $result = pg_query($conn, "select * from weekly_matches where week_number = '$week_number' and match_date = '2018-12-2' order by id asc;");
        include('./component/table_data.php');
      ?>
      </table>
      ...
      <?php
      $result = pg_query($conn, "select * from weekly_matches where week_number = '$week_number' and match_date = '2018-12-3' order by id asc;");
      include('./component/table_data.php');
      ?>
      </table>

        <div class="tiebreaker">
          <h2>Tie-Breaker Points: <?php echo "WAS/PHI" ?></h2>
        </div>
